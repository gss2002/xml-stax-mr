 ...
 */
public class AutoProgressMapper<KEYIN, VALIN, KEYOUT, VALOUT> extends XmlMrMapper<KEYIN, VALIN, KEYOUT, VALOUT> {

    public static final Log LOG = LogFactory.getLog(AutoProgressMapper.class.getName());

    public static final String MAX_PROGRESS_PERIOD_KEY = "xml.mapred.auto.progress.max";
    public static final String SLEEP_INTERVAL_KEY = "xml.mapred.auto.progress.sleep";
    public static final String REPORT_INTERVAL_KEY = "xml.mapred.auto.progress.report";
